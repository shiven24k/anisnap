  ...
  return (
    <>
      ...
      >
        ...
        {/* Hover overlay — user info + like button */}
        <Box
          position="absolute"
          bottom={0}
          left={0}
        ...
        >
          <Flex align="center" justify="space-between">
            ...
            <HStack spacing={1.5} minW={0} flex={1} mr={2}>
              ...
              <Link to={`/${userProfile?.username}`} onClick={e => e.stopPropagation()}>
                <Text color="white" fontSize="11px" fontWeight="600" lineHeight={1} noOfLines={1}>
          ...
          {/* Caption — one line */}
          {post.caption && (
            <Text color="whiteAlpha.750" fontSize="10px" mt="6px" noOfLines={1} pl="26px">
              {post.caption}
            </Text>
          )}
        </Box>
      ...
      {/* Comments modal — opens on card click */}
      {isOpen && (
